...
{//func_BookHist
 ...
 ZPt = new TH1D("ZPt","ZPt",50,0,100);
 ZPt->Sumw2();

 ZPt_SN = new TH1D("ZPt_SN","ZPt_SN",50,0,100);
 ZPt_SN->Sumw2();

 ZPt_SP = new TH1D("ZPt_SP","ZPt_SP",50,0,100);
 ZPt_SP->Sumw2();
 ...
 F_SP = new TH1D("F_SP","F_SP",140,60,130);
 F_SP->Sumw2();

 B_SP = new TH1D("B_SP","B_SP",140,60,130);
 B_SP->Sumw2();

 F_SN = new TH1D("F_SN","F_SN",140,60,130);
 F_SN->Sumw2();

 B_SN = new TH1D("B_SN","B_SN",140,60,130);
 B_SN->Sumw2();
 ...
 muon_antimuon_P = new TH2D("muon_antimuon_P","muon_antimuon_P",9,-1.8,1.8,9,-1.8,1.8);
 muon_antimuon_P->Sumw2();

 muon_antimuon_N = new TH2D("muon_antimuon_N","muon_antimuon_N",9,-1.8,1.8,9,-1.8,1.8);
 muon_antimuon_N->Sumw2();

 muon_Pt_etaP = new TH1D("muon_Pt_etaP","muon_Pt_etaP",50,0,100);
 muon_Pt_etaP->Sumw2();

 muon_Pt_etaN = new TH1D("muon_Pt_etaN","muon_Pt_etaN",50,0,100);
 muon_Pt_etaN->Sumw2();

 ZMass_eta0_Pt = new TH1D("ZMass_eta0_Pt","ZMass_eta0_Pt",36,74,110);
 ZMass_eta0_Pt->Sumw2();
}//func_BookHist
