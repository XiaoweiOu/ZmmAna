void syst_eff()
{
 ...
 TFile *MC_file = new TFile("MC_result/MC_Normal_" + str + ".root");
 TFile *data_file = new TFile("data_Normal/data_result.root");
 TFile *EW_file = new TFile("EW_norm_"+str+".root");
 TFile *QCD_file = new TFile("QCD_spectrum_"+str+".root");
