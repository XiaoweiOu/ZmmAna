...
{//func_ZmmAna
 ...
 if(Is_eff1==true)
 {
  ...
  {
   temp2 = ".x ../include/Id_Efficiency_Eta.C";
   gROOT->ProcessLine(temp2.c_str());
   Id_eff_1D = (TH1D *)gROOT->FindObject("Id_Scalefactor");

   temp2 = ".x ../include/Trk_Efficiency_Eta.C";
   gROOT->ProcessLine(temp2.c_str());
   Trk_eff_1D = (TH1D *)gROOT->FindObject("Trk_Scalefactor");

   temp2 = ".x ../include/Iso_Efficiency_Eta.C";
   gROOT->ProcessLine(temp2.c_str());
   Iso_eff_1D = (TH1D *)gROOT->FindObject("Iso_Scalefactor");
  }
