...
void cal_eff()
{
 ...
 TFile *data_file = new TFile("../muon_eff_LumiTest/result/data_"+(TString)lumix+"_result.root");
 TFile *MC_file = new TFile("../muon_eff_LumiTest/result/MC_0_"+(TString)lumix+"_result.root");
 TFile *EW_file = new TFile("../muon_eff_LumiTest/EW_norm_"+(TString)lumix+".root");
 TFile *result_file = new TFile("./cal_eff_"+(TString)lumix+".root","RECREATE");
 ...
 //2D efficiency
 fstream bkg_file("help_"+(TString)lumix+".txt");
